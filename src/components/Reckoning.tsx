...
export const Reckoning: React.FC<ReckoningProps> = ({ logs, onCommit, streak }) => {
  ...
  return (
    <div className="h-full w-full bg-background flex flex-col p-6 md:p-12 overflow-y-auto custom-scrollbar">
      <header className="flex justify-between items-start mb-8 md:mb-12 border-b parchment-border pb-4 md:pb-6">
        <div>
          <h2 className="text-3xl md:text-5xl font-display italic text-parchment">The Reckoning</h2>
          <p className="text-[8px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] opacity-40 mt-1 md:mt-2">
            An honest audit of existence
          </p>
        </div>
      ...
      <form onSubmit={handleCommit} className="space-y-10 md:space-y-12 max-w-2xl mx-auto w-full pb-32 md:pb-20">
